...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .codebox {
            border: 1px solid #053060 !important;
    ...
    <style type="text/css">
        ...
        input[type="submit"].logbutt {
            background: none repeat scroll 0 0 #265b92;
            border: medium none;
            border-radius: 5px;
            color: #fff;
            cursor: pointer;
        ...
        .login-panel-inner {
            background: transparent url("../App_Themes/skyblue/images/login-panel.png") no-repeat scroll 0px 0px;
            height: 360px;
            padding: 195px 30px 0px;
            width: 305px;
        }
        ...
        .white_content-new-1 {
            background: transparent url("../App_Themes/skyblue/images/overlay.png") repeat scroll 0px 0px;
            float: left;
            height: 100%;
            left: 0px;
            position: fixed;
        ...
        .close-1 {
            background: transparent url("../App_Themes/skyblue/images/closebutton.png") no-repeat scroll 0px 0px;
            cursor: pointer;
            float: right;
            font-size: 0px;
            height: 22px;
        ...
        .pluser {
            background: url("../App_Themes/skyblue/images/usr.png") no-repeat scroll 5px 5px #fff;
            border: 1px solid #053060 !important;
        ...
        .plpass {
            background: url("../App_Themes/skyblue/images/pwd.png") no-repeat scroll 5px 5px #fff;
            border: 1px solid #053060 !important;
            border-radius: 5px;
            padding: 6px 6px 6px 25px !important;
            width: 238px;
